...
const Profile = () => {
  ...
  const renderBooksSection = useCallback(
    (list, emptyMessage, limit) => {
      const data =
        typeof limit === "number" ? list.slice(0, limit) : list;

      if (!data.length) {
        return <div className="empty-books">{emptyMessage}</div>;
      }
          ...
          {isEditing ? (
            <div className="edit-form">
              <div className="form-group">
                <label>Name</label>
              <input style = {{color :'black'}} type="text" name="name" value={formData.name} onChange={handleChange} placeholder="Name" />
              </div>
              <div className="form-group">
                <label>Email</label>
              <input style = {{color :'black'}} type="email" name="email" value={formData.email} onChange={handleChange} placeholder="Email" />
              </div>
              <div className="form-group">
                <label>Bio</label>
              <textarea style = {{color :'black'}} name="bio" value={formData.bio} onChange={handleChange} placeholder="Bio" />
              </div>
