  ...
  return (
    <div>
      ...
      <div className="admin-clubs-container">
        <h2 style={{color:'black'}}>Manage All Clubs</h2>
        <Modal
      ...
      >
        <div className="modal-header">
          <h3 style={{color:'black'}}>Admin Deletion Reason</h3>
          <button 
            className="close-btn"
        ...
        {loading ? (
          ...
          <div style={{color:'black'}}>No clubs found matching your search</div>
        ) : (
          <div className="clubs-grid">
            {filteredClubs.map(club => (
              <div key={club._id} className="club-card">
                <div className="club-header">
                  <h3 style = {{color: 'black'}}>{club.name}</h3>
