  ...
  return (
    <div>
      ...
      <section className="benefits">
        <h2 style={{ color: '#2c3e50' }}>📖 Why Join ClubLit?</h2>
        <div className="benefitList">
          <div className="benefitItem">
            <h3 style={{ color: '#2c3e50' }}>📚 Diverse Selection</h3>
            <p style={{ color: '#2c3e50' }}>Explore books from various genres curated by fellow readers.</p>
          </div>
          <div className="benefitItem">
            <h3 style={{ color: '#2c3e50' }}>🌍 Engaging Community</h3>
            <p style={{ color: '#2c3e50' }}>Connect with book lovers and discuss your favorite reads.</p>
          </div>
          <div className="benefitItem">
            <h3 style={{ color: '#2c3e50' }}>🔍 Personalized Picks</h3>
            <p style={{ color: '#2c3e50' }}>Receive book recommendations tailored to your taste.</p>
          </div>
          <div className="benefitItem">
            <h3 style={{ color: '#2c3e50' }}>🎉 Fun Challenges</h3>
            <p style={{ color: '#2c3e50' }}>Join book clubs, reading challenges, and themed discussions.</p>
      ...
      <section className="bookQuotes">
        <h2 style={{ color: '#2c3e50' }}>📜 Inspiring Book Quotes</h2>
